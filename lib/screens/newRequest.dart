              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            padding:
                                EdgeInsets.only(bottom: textContainersPadding),
                            width: double.infinity,
                                      ...
                                      onPressed: () async {
                                        LocationResult result =
                                            await showLocationPicker(context,
                                                "AIzaSyDXX99ZU6zY1RMsTrAMpQxC5rRk8_LrwQ4");
                                        print("result = $result");
                                        setState(() {
                                          if (result != null) {
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: Provider.of<FormDataProvider>(context)
                          ...
                          return DropdownMenuItem<String>(
                            value: driver.id,
                            child: Container(
                                child: Text(driver.name, style: textDropStyle),
                                width: 200),
                          );
                        }).toList(),
                  ...
                  Flexible(
                      fit: FlexFit.loose,
                      child: textFormFieldContainer(
                          "Priority", _priorityController, null,
